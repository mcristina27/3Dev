...
// ── SVG filter que genera el efecto de distorsión de vidrio líquido ──
...
// ── Wrapper genérico con efecto glass líquido ──
...
export const GlassEffect: React.FC<GlassEffectProps> = ({
  ...
  >
    ...
    />
    {/* Capa 2 — blanco semi-transparente */}
    <div
...
export const GlassButton: React.FC<GlassButtonProps> = ({
  ...
  <GlassEffect
    onClick={onClick}
    className={`rounded-full px-8 py-3.5 hover:scale-[1.02] active:scale-[0.98] ${className}`}
  >
    <div
      className="transition-all duration-700 flex items-center justify-center gap-2"
