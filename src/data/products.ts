...
export const ALL_PRODUCTS: Product[] = [
...

  {
    ...
    name:        "Llavero Claude",
    category:    "accesorios",
    images:      ["/assets/products/keychain-claude.png"],
    price:       3,
    shortDesc:   "Llavero con el mascot de Claude. El accesorio perfecto para devs.",
    description: "Llavero con el icónico mascot de Claude en 3D. Hecho en PLA, compacto y resistente. El accesorio indispensable para cualquier dev fan de la IA.",
    material:    "PLA",
    colors:      ["A elegir"],
    size:        "4 cm",
    weight:      "12 g",
    ...
    featured:    true,
    inStock:     true,
    searchTags:  ["llavero", "claude", "anthropic", "ai", "dev", "accesorio"],
  },
  {
    id:          25,
    name:        "Llavero Dino",
    ...
    featured:    true,
    inStock:     true,
    searchTags:  ["llavero", "dino", "dinosaurio", "kawaii", "cute", "accesorio"],
  },
